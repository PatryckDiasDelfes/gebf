...
export default function AddPost(prop: NewPost) {
...
{/* Meu botão que abre o modal */}
                <button onClick={() => { setModalState("flex") }} className="fixed  bg-[#DAC8F7] bg-opacity-50 font-bold bottom-10 text-[18px] border p-3 border-[#070707] border-solid rounded-2xl">
                    adcionar
                </button>
